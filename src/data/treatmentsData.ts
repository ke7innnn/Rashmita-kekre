...
export interface TreatmentMethod {
  ...
  category: 'exercise' | 'electro' | 'manual' | 'care' | 'bcst';
  categoryLabel: string;
}

export const treatmentCategories: TreatmentCategory[] = [
  { id: 'all', label: 'All Methods', description: 'Providing expert rehabilitation programs engineered for recovery, balance, and independence.' },
  { id: 'bcst', label: 'Biodynamic Craniosacral Therapy', description: 'Biodynamic Craniosacral Therapy (BCST) is a gentle, hands-on therapy that supports the body’s natural ability to heal and restore balance by calming the nervous system and enhancing overall wellbeing. Using light, non-invasive touch, BCST may help relieve stress, chronic pain, headaches, fatigue, sleep disturbances, and the effects of physical or emotional trauma, making it a valuable complement to physiotherapy and medical care.' },
  { id: 'exercise', label: 'Exercise & Sports', description: 'Recover strength, improve endurance, and enhance functional mobility with our specialized conditioning programs.' },
  { id: 'electro', label: 'Electro & Heat', description: 'Advanced electrotherapy and localized thermal therapies to manage pain, stimulate muscles, and accelerate healing.' },
  { id: 'manual', label: 'Hands-on & Specialized', description: 'Manual adjustments, myofascial release, joint mobilizations, and specialized clinic-based therapeutic interventions.' },
  { id: 'care', label: 'Modern Care & Home', description: 'Accessible online consultations, fall-prevention assessments, and tailored therapy plans delivered in the comfort of your home.' }
];
...
export const treatmentMethods: TreatmentMethod[] = [
  ...
  },
  {
    ...
    description: "Biodynamic Craniosacral Therapy (BCST) is a gentle, hands-on therapy that supports the body’s natural ability to heal and restore balance by calming the nervous system and enhancing overall wellbeing. Using light, non-invasive touch, BCST may help relieve stress, chronic pain, headaches, fatigue, sleep disturbances, and the effects of physical or emotional trauma, making it a valuable complement to physiotherapy and medical care.",
    oneLineDescription: "A gentle, hands-on therapy that calms the nervous system and supports natural healing.",
    category: "bcst",
    categoryLabel: "Biodynamic Craniosacral Therapy"
  }
];
