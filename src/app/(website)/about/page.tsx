                  ...
                  >
                    <motion.img 
                      ...
                      style={{ 
                        ...
                        y: photoY, 
                        scale: 1.05,
                        filter: 'contrast(1.06) brightness(1.02) saturate(1.08) sepia(0.06)'
                      }} 
                    />
                    ...
                    <div style={{
                      position: 'absolute',
                      inset: 0,
                      background: 'radial-gradient(ellipse at center, transparent 55%, rgba(20, 10, 5, 0.18) 100%)',
                      pointerEvents: 'none',
                      borderRadius: '24px'
                    }} />
                    ...
                    <div style={{
                      ...
                      height: '40%',
                      background: 'linear-gradient(to top, rgba(10, 8, 5, 0.45) 0%, transparent 100%)',
                      pointerEvents: 'none',
