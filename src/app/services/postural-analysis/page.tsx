        ...
        <section style={{ padding: '4rem 0' }}>
          <div className="xpad" style={{ maxWidth: '850px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <h2 style={{ fontSize: '2rem', fontWeight: 500, marginTop: '0.5rem' }}>Sample Posture Report Card</h2>
            </div>
            ...
            >
              <div style={{ display: 'flex', justifySelf: 'stretch', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(0,0,0,0.06)', paddingBottom: '1.25rem', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '6px 14px', background: 'rgba(0,159,199,0.06)', borderRadius: '9999px', fontSize: '0.85rem', color: 'var(--brand)', fontWeight: 500 }}>
                  <ScanLine size={16} /> Posture Score: 94/100
                </div>
              </div>

              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  <span style={{ fontSize: '0.8rem', color: 'var(--muted-foreground)', textTransform: 'uppercase' }}>Spine Alignment</span>
                  <span style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--foreground)' }}>98%</span>
                  <div style={{ height: '6px', background: 'rgba(0,0,0,0.05)', borderRadius: '3px', overflow: 'hidden' }}>
                    <div style={{ width: '98%', height: '100%', background: 'var(--brand)' }}></div>
                  </div>
                </div>

                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  <span style={{ fontSize: '0.8rem', color: 'var(--muted-foreground)', textTransform: 'uppercase' }}>Pelvic Tilt Index</span>
                  <span style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--foreground)' }}>2.4°</span>
                  <div style={{ height: '6px', background: 'rgba(0,0,0,0.05)', borderRadius: '3px', overflow: 'hidden' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  <span style={{ fontSize: '0.8rem', color: 'var(--muted-foreground)', textTransform: 'uppercase' }}>Weight Balance (L / R)</span>
                  <span style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--foreground)' }}>48% / 52%</span>
                  <div style={{ height: '6px', background: 'rgba(0,0,0,0.05)', borderRadius: '3px', overflow: 'hidden' }}>
                    <div style={{ width: '52%', height: '100%', background: 'var(--brand)' }}></div>
                  </div>
                </div>
              </div>
            </motion.div>
