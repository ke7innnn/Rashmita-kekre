              ...
              >
                ...
                <div id="rights">
                  ...
                  <div style={{ display: 'flex', gap: '10px', alignItems: 'center', background: 'rgba(0,0,0,0.02)', padding: '1rem', borderRadius: '12px', marginTop: '1rem', fontSize: '0.95rem', color: 'var(--muted-foreground)' }}>
                    <Mail size={18} style={{ color: 'var(--brand)', flexShrink: 0 }} /> Contact our data privacy officer at <a href="mailto:privacy@health360.clinic" style={{ textDecoration: 'underline', marginLeft: '4px' }}>privacy@health360.clinic</a>.
                  </div>
                </div>
              </motion.div>
