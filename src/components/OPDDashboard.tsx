                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center gap-2 pb-3 border-b border-white/10">
                      ...
                      {(() => {
                        ...
                        return (
                          <span className="text-[10px] font-bold px-2.5 py-1 bg-white/10 border border-white/20 text-white rounded-xl num-tabular shrink-0">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-3 min-w-0">
                        <div className={`h-10 w-10 rounded-2xl flex items-center justify-center font-bold text-xs uppercase shrink-0 border shadow-md ${config.initialsBg}`}>
                          {initials}
                        </div>
                      ...
                      {(app.notes || (app.assignedExercises && app.assignedExercises.length > 0)) && (
                        <div className="flex flex-wrap gap-1.5 pt-1 border-t border-white/10">
                          ...
                          {app.assignedExercises && app.assignedExercises.length > 0 && (
                            <span className="inline-flex items-center gap-1 text-[9px] font-bold px-2 py-0.5 bg-[#FFB454]/15 text-[#FFB454] border border-[#FFB454]/30 rounded-md num-tabular">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="min-w-0 flex-1">
                        {(() => {
                          ...
                          if (isCheckedIn) {
                            return (
                              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-amber-500/15 border border-amber-500/40 text-amber-300 text-[10px] font-mono font-bold">
                          ...
                          if (isNoShow) {
                            return (
                              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-rose-500/15 border border-rose-500/40 text-rose-400 text-[10px] font-semibold">
                          ...
                          return (
                            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-white/5 border border-white/10 text-white/60 text-[10px] font-semibold">
                      ...
                      <button 
                        ...
                        className="px-3 py-1.5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/15 text-xs font-bold text-white transition-all cursor-pointer shrink-0"
                      >
                        Details
                      </button>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      {!app.checkInAt && !app.checkInTime && app.status !== 'COMPLETED' && app.status !== 'NO_SHOW' && (
                        <>
                          <button
                            ...
                            className="flex-1 py-2 px-3.5 rounded-xl bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-black font-bold text-xs flex items-center justify-center gap-1.5 shadow-lg transition-all cursor-pointer"
                          >
                            <LogIn size={13} />
                            Check In
                          </button>
                          ...
                          <button
                            ...
                            className="py-2 px-3 rounded-xl border border-rose-500/40 hover:bg-rose-500/20 text-rose-300 text-xs font-semibold flex items-center justify-center transition-all cursor-pointer"
                            title="Mark No-Show"
                          >
                            No-Show
                          </button>
                      ...
                      {(app.checkInAt || app.checkInTime) && !app.checkOutAt && app.status !== 'COMPLETED' && app.status !== 'NO_SHOW' && (
                        <button
                          ...
                          className="w-full py-2 px-3.5 rounded-xl bg-gradient-to-r from-emerald-400 to-teal-400 hover:from-emerald-300 hover:to-teal-300 text-black font-bold text-xs flex items-center justify-center gap-1.5 shadow-lg transition-all cursor-pointer"
                        >
                          <LogOut size={13} />
                          Check Out Patient
                        </button>
