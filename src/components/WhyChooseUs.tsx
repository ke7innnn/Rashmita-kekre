...
const FEATURES = [
  { icon: <Award size={22} />, title: '15+ Years of Experience', desc: 'Dr. Rashmita brings over a decade of hands-on clinical expertise in orthopedic, neurological, and pediatric physiotherapy.' },
